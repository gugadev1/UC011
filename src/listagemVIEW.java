...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if (idTexto.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Informe o ID do produto para venda.");
            return;
        }
        ...
        if (vendido) {
            ...
            String detalhe = produtosdao.getUltimoErro();
            String mensagem = "Não foi possível vender o produto.";
    ...
    private void listarProdutos(){
        try {
            ...
            String erroListagem = produtosdao.getUltimoErro();
            if (erroListagem != null && !erroListagem.isBlank()) {
                JOptionPane.showMessageDialog(this, "Erro ao listar produtos.\nDetalhe: " + erroListagem);
                return;
            }
